            ...
            <React.Fragment key={i}>
              ...
              >
                <div className="flex flex-col sm:flex-row gap-4 border-b border-gray-300 pb-6 bg-white">
                  <img
                    src={course.image}
                    alt={course.title}
                    className="w-full sm:w-[332px] h-[200px] sm:h-[230px] object-cover rounded border"
                  />
              ...
              {i === 5 && (
                <div className="w-full max-w-4xl mx-auto flex justify-center py-16">
                  <div className="flex items-center gap-6 px-6 sm:px-12 py-6 rounded-xl bg-white shadow-md text-purple-700 text-lg font-semibold">
                    <button className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center border border-purple-300 rounded-full hover:bg-purple-100 transition">
                      &lt;
                    </button>
