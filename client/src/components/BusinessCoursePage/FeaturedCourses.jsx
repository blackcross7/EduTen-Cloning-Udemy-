...
const featuredCourses = [
  {
    ...
    description: "Learn how to start freelancing on Fiverr, get your first client, and scale to a full-time income.",
    updated: "June 2025",
    hours: "3.5",
    lectures: "33",
    level: "Beginner",
  ...
  },
  {
    ...
    description: "Leverage GPT for data analysis, flowcharts, audit prep, and quality documentation",
    updated: "June 2025",
    hours: "2",
    lectures: "22",
    level: "All Levels",
  ...
  },
  {
    ...
    description: "Master business communication, leadership, public speaking, and soft skills",
    updated: "June 2025",
    hours: "5.5",
    lectures: "46",
    level: "All Levels",
...
const FeaturedCourses = () => {
  ...
  return (
    <section className="relative px-4 lg:px-20 py-10 bg-white">
