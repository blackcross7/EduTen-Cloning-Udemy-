...
const featuredCourses = [
  {
    image: "/assets/design/mothgirl.jpg",
    title: "Full game character in Blender course ",
    instructor: "Nikolay Naydenov",
    description:
      "Creating a game ready character with textures only in Blender! No other tools used.",
    updated: "June 2025",
    hours: "50",
    lectures: "74",
    level: "Intermediate",
  ...
  {
    image: "/assets/design/web-design.jpg",
    title: "Web Design for WordPress Users",
    instructor: "Andrew Williams",
    description:
      "Master WordPress web design with responsive layouts, UX, SEO, and real-world skills to build stunning websites.",
    updated: "June 2025",
    hours: "10",
    lectures: "72",
    level: "All Levels",
  ...
  },
  {
    ...
    description:
      "Learn how to create Parametric Clothing compatible with MetaHuman Creator to sell on Fab",
    updated: "July 2025",
    hours: "4.5",
    lectures: "36",
    level: "Beginner",
...
const FeaturedCoursesDesignPage = () => {
                ...
                <div className="p-6 flex flex-col justify-between w-full md:w-[55%]">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mb-3">
                      Updated <strong>{course.updated}</strong> · {course.hours} total hours · {course.lectures} lectures · {course.level}
                    </p>
...
export default FeaturedCoursesDesignPage;
