...
const dummyCourses = [
  {
    id: 1,
    image: "/assets/design/fashion1.jpg",
  ...
  {
    id: 2,
    image: "/assets/design/fashion2.jpg",
    title: "Textile & Apparel Design",
  ...
  {
    id: 3,
    image: "/assets/design/fashion3.jpg",
...
const SidebarFilters = () => (
  <aside className="w-full md:w-64 bg-white rounded-lg shadow p-4 mb-6 md:mb-0">
    ...
    <div className="mb-4">
      ...
      <div className="flex flex-col gap-1">
        <label><input type="checkbox" /> Textile</label>
        <label><input type="checkbox" /> Apparel</label>
        <label><input type="checkbox" /> Illustration</label>
        <label><input type="checkbox" /> Pattern Making</label>
      </div>
    </div>
    <div className="mb-4">
...
const FaashionDesign = () => {
  const [sort, setSort] = useState("popular");
  return (
    <>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
          <h1 className="text-2xl font-bold">Fashion Design Courses</h1>
