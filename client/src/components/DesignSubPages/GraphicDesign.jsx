...
const dummyCourses = [
  {
    id: 1,
    image: "/assets/design/graphic1.jpg",
    title: "Graphic Design Masterclass: Photoshop, Illustrator, InDesign",
    instructor: "Sonal Jain",
    rating: 4.8,
    reviews: 8800,
    price: 499,
    bestseller: true,
  ...
  {
    id: 3,
    image: "/assets/design/graphic3.webp",
    title: "Canva for Beginners: Design Like a Pro",
    instructor: "Megha Sharma",
    rating: 4.6,
    reviews: 6100,
    price: 299,
    bestseller: true,
  ...
  <aside className="w-full md:w-64 bg-white rounded-lg shadow p-4 mb-6 md:mb-0">
    ...
    <div className="mb-4">
      ...
      <div className="flex flex-col gap-1">
        ...
        <label><input type="checkbox" /> Illustrator</label>
        <label><input type="checkbox" /> Canva</label>
        <label><input type="checkbox" /> InDesign</label>
      </div>
    </div>
    <div className="mb-4">
    ...
    <>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
          <h1 className="text-2xl font-bold">Graphic Design Courses</h1>
