...
const dummyCourses = [
  {
    id: 1,
    image: "/assets/design/3dmodeling1.jpg",
    title: "3D Modeling for Beginners: Blender Essentials",
  ...
  {
    id: 2,
    image: "/assets/design/3dmodeling2.jpg",
    title: "Mastering Autodesk Maya: 3D Animation",
  ...
  <aside className="w-full md:w-64 bg-white rounded-lg shadow p-4 mb-6 md:mb-0">
    ...
    <div className="mb-4">
      ...
      <div className="flex flex-col gap-1">
        ...
        <label><input type="checkbox" /> Maya</label>
        <label><input type="checkbox" /> Cinema 4D</label>
    ...
    <>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
          <h1 className="text-2xl font-bold">3D Modeling Courses</h1>
