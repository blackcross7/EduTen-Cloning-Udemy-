      ...
      <div className="flex justify-start gap-4 mb-6">
        <button
          ...
          className={`w-10 h-10 rounded-full flex items-center justify-center border transition ${
            canScrollLeft ? "border-black text-black hover:bg-gray-100" : "border-gray-300 text-gray-300 cursor-not-allowed"
          }`}
        >
          <ChevronLeft size={20} />
        </button>
        <button
          ...
          className={`w-10 h-10 rounded-full flex items-center justify-center border transition ${
            canScrollRight ? "border-black text-black hover:bg-gray-100" : "border-gray-300 text-gray-300 cursor-not-allowed"
          }`}
        >
