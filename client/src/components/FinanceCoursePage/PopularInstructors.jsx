...
const instructors = [
  {
    name: "Neha Sinha",
    title: "Chartered Accountant (CA), Taxation Specialist",
    rating: 4.8,
    students: "712,459",
    courses: 35,
  ...
  {
    name: "Amit Deshmukh",
    title: "CFA Charterholder, Investment Analyst",
    rating: 4.7,
    students: "1,120,342",
    courses: 48,
    image: "/assets/business/testimonial-person.png",
  ...
  {
    name: "Rahul Verma",
    title: "Certified Financial Planner (CFP), Wealth Manager",
    rating: 4.7,
    students: "679,890",
    courses: 31,
    image: "/assets/business/testimonial-person.png",
  ...
  {
    name: "Swati Mehra",
    title: "Cost Accountant, Budgeting & Forecasting",
    rating: 4.6,
    students: "445,726",
    courses: 22,
    image: "/assets/business/testimonial-person.png",
  ...
  {
    name: "Kunal Jain",
    title: "Equity Research & Stock Market Trainer",
    rating: 4.8,
    students: "98,231",
    courses: 18,
    image: "/assets/business/testimonial-person.png",
