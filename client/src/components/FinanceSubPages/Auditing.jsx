...
const dummyCourses = [
  {
    id: 1,
    image: "https://tse1.mm.bing.net/th/id/OIP.rh2n1BtM_7gXMOujQa8oSQHaDt?pid=Api&P=0&h=180",
  ...
  {
    id: 2,
    image: "https://www.businessfirstonline.co.uk/wp-content/uploads/2019/11/audit-4189560_1920.jpg",
  ...
  {
    id: 3,
    image: "https://backofficesupportsolutions.com/wp-content/uploads/2014/04/audit-preparation-backofficesupportsolutions.com_.jpg",
    title: "Risk & Compliance Auditing",
...
const SidebarFilters = () => (
  <aside className="w-full md:w-64 bg-white rounded-lg shadow p-4 mb-6 md:mb-0">
    ...
    <div className="mb-4">
      ...
      <div className="flex flex-col gap-1">
        <label><input type="checkbox" /> Internal Audit</label>
        <label><input type="checkbox" /> Risk & Compliance</label>
        <label><input type="checkbox" /> Forensic Audit</label>
    ...
    <>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
          <h1 className="text-2xl font-bold">Auditing Courses</h1>
