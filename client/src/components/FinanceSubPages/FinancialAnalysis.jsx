...
const SidebarFilters = () => (
  <aside className="w-full md:w-64 bg-white rounded-lg shadow p-4 mb-6 md:mb-0">
    ...
    <div className="mb-4">
      ...
      <div className="flex flex-col gap-1">
        <label><input type="checkbox" /> Financial Modeling</label>
        <label><input type="checkbox" /> Statement Analysis</label>
        <label><input type="checkbox" /> Certification</label>
        <label><input type="checkbox" /> Ratio Analysis</label>
      </div>
    </div>
    <div className="mb-4">
    ...
    <>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
          <h1 className="text-2xl font-bold">Financial Analysis Courses</h1>
