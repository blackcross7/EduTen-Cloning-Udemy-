...
const HealthAndFitnessCourseSection = () => {
  return (
    <section className="py-12 bg-gradient-to-b from-[#f8fafc] to-[#f1f5f9]">
      <h2 className="text-3xl font-extrabold mb-8 text-purple-700 border-b-4 border-purple-200 inline-block px-2">Health & Fitness Courses</h2>
...
export default HealthAndFitnessCourseSection; 