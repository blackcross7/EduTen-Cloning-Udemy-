...
const dummyCourses = [
  {
    id: 1,
    image: "/assets/itsoftware/aws-course.webp",
  ...
  {
    id: 2,
    image: "/assets/itsoftware/azure-course.jpg",
  ...
  {
    id: 3,
    image: "/assets/itsoftware/devops.webp",
    title: "DevOps Masterclass: Docker, Kubernetes, Jenkins, CI/CD",
    instructor: "Meena Gupta",
    rating: 4.7,
    reviews: 8900,
    price: 1799,
    bestseller: true,
  ...
  <aside className="w-full md:w-64 bg-white rounded-lg shadow p-4 mb-6 md:mb-0">
    ...
    <div className="mb-4">
      ...
      <div className="flex flex-col gap-1">
        ...
        <label><input type="checkbox" /> Azure</label>
        <label><input type="checkbox" /> Google Cloud</label>
    ...
    <>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
          <h1 className="text-2xl font-bold">Cloud Computing Courses</h1>
