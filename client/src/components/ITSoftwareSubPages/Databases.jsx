...
const dummyCourses = [
  {
    id: 1,
    image: "/assets/itsoftware/sql-course.jpg",
  ...
  {
    id: 2,
    image: "/assets/itsoftware/mysql-course.jpg",
  ...
  {
    id: 3,
    image: "/assets/itsoftware/mongodb-course.png",
    ...
    <>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
          <h1 className="text-2xl font-bold">Database Courses</h1>
