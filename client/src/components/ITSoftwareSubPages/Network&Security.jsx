...
const dummyCourses = [
  {
    id: 1,
    image: "/assets/itsoftware/network1.png",
  ...
  {
    id: 2,
    image: "/assets/itsoftware/network2.jpg",
    title: "Cisco CCNA: Networking Basics",
  ...
  {
    id: 3,
    image: "/assets/itsoftware/network3.png",
  ...
  <aside className="w-full md:w-64 bg-white rounded-lg shadow p-4 mb-6 md:mb-0">
    ...
    <div className="mb-4">
      ...
      <div className="flex flex-col gap-1">
        ...
        <label><input type="checkbox" /> Cisco CCNA</label>
        <label><input type="checkbox" /> Ethical Hacking</label>
    ...
    <>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
          <h1 className="text-2xl font-bold">Network & Security Courses</h1>
