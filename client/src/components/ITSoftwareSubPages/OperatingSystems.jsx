...
const dummyCourses = [
  {
    id: 1,
    image: "/assets/itsoftware/windows-course.jpg",
  ...
  {
    id: 2,
    image: "/assets/itsoftware/linux-course.jpg",
    title: "Linux for Beginners: Command Line & Shell Scripting",
  ...
  {
    id: 3,
    image: "/assets/itsoftware/macos-course.jpg",
    title: "macOS Fundamentals: System Management",
    ...
    <>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
          <h1 className="text-2xl font-bold">Operating Systems Courses</h1>
