...
const HealthMeditationPage = () => (
  <main className="py-12 px-4 max-w-6xl mx-auto">
    <h1 className="text-3xl font-bold text-purple-700 mb-6">Meditation Courses</h1>
    <p className="text-gray-700 mb-8">Explore Meditation courses to help you relax, focus, and find inner peace.</p>
    ...
    <section className="mb-10">
      <h2 className="text-xl font-bold text-purple-700 mb-4">Popular Meditation Topics</h2>
    ...
    {/* Course Grid */}
    <section className="mb-10">
      <h2 className="text-xl font-bold text-purple-700 mb-4">All Meditation Courses</h2>
...
export default HealthMeditationPage; 