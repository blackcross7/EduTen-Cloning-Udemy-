...
const HealthMentalHealthPage = () => (
  <main className="py-12 px-4 max-w-6xl mx-auto">
    <h1 className="text-3xl font-bold text-purple-700 mb-6">Mental Health Courses</h1>
    <p className="text-gray-700 mb-8">Browse our Mental Health courses to support your emotional well-being and resilience.</p>
    ...
    <section className="mb-10">
      <h2 className="text-xl font-bold text-purple-700 mb-4">Popular Mental Health Topics</h2>
    ...
    {/* Course Grid */}
    <section className="mb-10">
      <h2 className="text-xl font-bold text-purple-700 mb-4">All Mental Health Courses</h2>
...
export default HealthMentalHealthPage; 