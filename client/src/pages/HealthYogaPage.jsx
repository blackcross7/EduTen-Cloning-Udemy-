...
const courses = [
  ...
  {
    id: 4,
    title: "Yoga for Strength & Balance",
...
const HealthYogaPage = () => (
  <main className="py-12 px-4 max-w-6xl mx-auto">
    <h1 className="text-3xl font-bold text-purple-700 mb-6">Yoga Courses</h1>
    <p className="text-gray-700 mb-8">Explore our best Yoga courses and resources to improve your flexibility, strength, and peace of mind.</p>
    ...
    <section className="mb-10">
      <h2 className="text-xl font-bold text-purple-700 mb-4">Popular Yoga Topics</h2>
    ...
    {/* Course Grid */}
    <section className="mb-10">
      <h2 className="text-xl font-bold text-purple-700 mb-4">All Yoga Courses</h2>
